...
def main(configs):
    ...
    # start training 
    path =  './models/cgan/cgan_noise_'+str(configs.noise_dim)+'_g_'+str(configs.g_lr)+'_d_'+str(configs.d_lr)+'_STEP_'+ str(configs.if_lr_de) +'_trained.pth'
    path_temp = './models/cgan/cgan_noise_'+str(configs.noise_dim)+'_g_'+str(configs.g_lr)+'_d_'+str(configs.d_lr)+'_STEP_'+ str(configs.if_lr_de) +'_trained_temp.pth'
    ...
    for e in range(epochs):
        ...
        loss_train = train(model, train_loader, optimizer_G, optimizer_D, criterion, configs.prior)
