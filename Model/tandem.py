...
def main(configs):
    ...
    inverse_model = MLP(configs.output_dim, configs.input_dim).to(DEVICE)
    ...
    # start training 
    path =  './models/tandem/tandem_'+'_lr_'+str(configs.lr)+'_STEP_'+ str(configs.if_lr_de) +'_trained.pth'
